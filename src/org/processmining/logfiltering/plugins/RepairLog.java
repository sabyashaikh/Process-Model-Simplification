...
import org.processmining.logfiltering.algorithms.RepairBasedOnWindows;
...
@Plugin(name = " Repair Event Log!", parameterLabels = { "Event Log", "Parameter Object" }, returnLabels = {
...
public class RepairLog {
	...
	public static XLog run(PluginContext context, XLog log, MatrixFilterParameter parameters) {
		return RepairBasedOnWindows.apply(log, parameters);
	}
