...
import org.processmining.logfiltering.algorithms.FilterBaseOnSimilarityImp;
...
@Plugin(name = "Similarity base Filtering", parameterLabels = { "Event Log", "Parameter Object" }, returnLabels = {
		"Filtered Event Log" }, returnTypes = { XLog.class })
public class SimilarityBasedFiltering {
	...
	public class MatrixFilterWizardPanel extends JPanel {
		...
		private NiceIntegerSlider SubsequenceLength= SlickerFactory.instance().createNiceIntegerSlider("Please Select the threshold of Variants", 0, 100, 75, Orientation.HORIZONTAL);
		...
		public MatrixFilterParameter getParameters() {
			...
			return new MatrixFilterParameter(doubleSlider.getValue(),(FilterSelection) comboFilterSelectionType.getSelectedItem(),
	...
	public static XLog run(PluginContext context, XLog log, MatrixFilterParameter parameters) {
		return FilterBaseOnSimilarityImp.apply(log, parameters);
	}
