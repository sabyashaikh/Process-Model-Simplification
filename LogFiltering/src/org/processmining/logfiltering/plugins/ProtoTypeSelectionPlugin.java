...
public class ProtoTypeSelectionPlugin {
...
public class MatrixFilterWizardPanel extends JPanel {
		...
		private NiceIntegerSlider SubsequenceLength= SlickerFactory.instance().createNiceIntegerSlider("Please Select the Percentages of Variants", 0, 100, 90, Orientation.HORIZONTAL);
