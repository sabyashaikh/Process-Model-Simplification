...
import org.processmining.logfiltering.algorithms.SampleVariants;
...
@Plugin(name = "Variant Sampling", parameterLabels = { "Event Log", "Parameter Object" }, returnLabels = {
		"Sampled Event Log" }, returnTypes = { XLog.class })
public class VariantSampelingPlugin {
	...
	public static XLog run(PluginContext context, XLog log, MatrixFilterParameter parameters) {
		return SampleVariants.apply(log, parameters);
	}
